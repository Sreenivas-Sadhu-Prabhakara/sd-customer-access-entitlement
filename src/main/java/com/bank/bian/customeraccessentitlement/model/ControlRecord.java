package com.bank.bian.customeraccessentitlement.model;
...
/**
 * The BIAN control record for this service domain: "Access Entitlement Administrative Plan".
 *
 ...
 * to its asset type (Access Entitlement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Access Entitlement Administrative Plan";
